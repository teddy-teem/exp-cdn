const campaignId = "b7bf0644-b018-47ad-b2b5-86feb7c8e7d3";
let element = document.getElementById("b7bf0644-b018-47ad-b2b5-86feb7c8e7d3");
(async () => {
  addLoader();
  const response = await fetch(
    `http://localhost:8082/api/v1/campaign/${campaignId}`
  );
...
function addLoader() {
  var loaderContainer = document.getElementById("iamjahid");
